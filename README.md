...
## 📦 Container Registry (Production Images)
Aplikasi ini menggunakan pre-built production-ready images yang di-host di GitHub Container Registry (GHCR):
- **Backend Service**: `ghcr.io/lievlya/project-prediksi-kemiskinan-be:v1.0.0`
- **Frontend Service**: `ghcr.io/lievlya/project-prediksi-kemiskinan-fe:v1.0.0`
>>>>>>> c3b0e75 ([RELEASE] Update docker-compose to use GHCR production images for Ming 14)
